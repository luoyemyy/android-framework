 ...
 */
internal class BusRegistry  constructor(lifecycle: Lifecycle, private val mResult: BusResult, private var mEvents: Array<out String>) : BusManager.Callback, GenericLifecycleObserver {
